...
const copy: ArticleCopy = {
  ...
  sources: [
    ...
    { slug: "2026-2c70f730ab2d", title: { zh: "AHA 2026 儿童冠脉缺血检测科学声明", en: "AHA 2026 pediatric coronary ischemic testing statement" } },
    ...
    { slug: "2026-6728908de0ba", title: { zh: "MuSCAT：侵入性功能检查对决策的影响", en: "MuSCAT: invasive functional testing and decisions" } },
